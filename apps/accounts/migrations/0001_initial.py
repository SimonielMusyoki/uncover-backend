# Generated by Django 4.2.6 on 2023-10-20 07:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+254722000000', max_length=30, region=None, verbose_name='phone number')),
                ...
                ('city', models.CharField(default='Nairobi', max_length=50, verbose_name='city')),
                ('profile_photo', models.ImageField(default='profile_default.png', upload_to='', verbose_name='profile photo')),
                ('twitter_handle', models.CharField(blank=True, max_length=20, null=True, verbose_name='twitter handle')),
